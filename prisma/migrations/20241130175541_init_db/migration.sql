...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_professionalServiceId_fkey" FOREIGN KEY ("professionalServiceId") REFERENCES "professional_services"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
